...
-- 5. Thêm cột GroupId (nếu chưa có)
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'PERSONAL_EVENT' AND COLUMN_NAME = 'GroupId')
BEGIN
    ALTER TABLE PERSONAL_EVENT ADD GroupId NVARCHAR(255);
END
GO
