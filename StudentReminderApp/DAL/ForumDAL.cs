...
namespace StudentReminderApp.DAL
{
    public class ForumDAL : BaseDAL
    {
        ...
        ORDER BY bv.ngay_dang DESC";
            ...
            {
                System.Diagnostics.Debug.WriteLine($"SQL Error in GetPosts: {sqlEx.Message}");
                System.Diagnostics.Debug.WriteLine($"Error Number: {sqlEx.Number}");
                throw new InvalidOperationException("Lỗi truy cập cơ sở dữ liệu trong GetPosts", sqlEx);
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error in GetPosts: {ex.Message}");
                throw new InvalidOperationException("Lỗi không xác định trong GetPosts", ex);
            }
            return list;
        }
        ...
        public long AddPostAndGetId(long idAcc, string title, string content, bool isAnonymous, long? idOriginalPost = null, string backgroundColor = "Transparent")
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"SQL Error in AddPostAndGetId: {sqlEx.Message}");
                System.Diagnostics.Debug.WriteLine($"Error Number: {sqlEx.Number}");
                throw new InvalidOperationException("Lỗi khi thêm bài viết (SQL)", sqlEx);
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error in AddPostAndGetId: {ex.Message}");
                throw new InvalidOperationException("Lỗi khi thêm bài viết", ex);
            }
        }
        ...
        public bool AddDocument(long idPost, string fileName, string filePath)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"SQL Error in AddDocument: {sqlEx.Message}");
                throw new InvalidOperationException("Lỗi khi thêm tài liệu (SQL)", sqlEx);
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error in AddDocument: {ex.Message}");
                throw new InvalidOperationException("Lỗi khi thêm tài liệu", ex);
            }
        }
        ...
        public List<Comment> GetCommentsByPostId(long idPost)
        {
            ...
            { 
                System.Diagnostics.Debug.WriteLine($"SQL Error in GetCommentsByPostId: {sqlEx.Message}");
                throw new InvalidOperationException("Lỗi truy cập bình luận (SQL)", sqlEx);
            }
            catch (Exception ex) 
            { 
                System.Diagnostics.Debug.WriteLine($"Error in GetCommentsByPostId: {ex.Message}");
                throw new InvalidOperationException("Lỗi truy cập bình luận", ex);
            }
            return list;
        }
        ...
        public bool AddComment(long idPost, long idAcc, string content)
        {
            ...
            { 
                System.Diagnostics.Debug.WriteLine($"SQL Error in AddComment: {sqlEx.Message}");
                throw new InvalidOperationException("Lỗi khi thêm bình luận (SQL)", sqlEx);
            }
            catch (Exception ex) 
            { 
                System.Diagnostics.Debug.WriteLine($"Error in AddComment: {ex.Message}");
                throw new InvalidOperationException("Lỗi khi thêm bình luận", ex);
            }
        }
        ...
        public bool ToggleLike(long idAcc, long idPost)
        {
            ...
            { 
                System.Diagnostics.Debug.WriteLine($"SQL Error in ToggleLike: {sqlEx.Message}");
                throw new InvalidOperationException("Lỗi khi toggle like (SQL)", sqlEx);
            }
            catch (Exception ex) 
            { 
                System.Diagnostics.Debug.WriteLine($"Error in ToggleLike: {ex.Message}");
        ...
        public bool AddSharedPost(long idPostGoc, long idAccNguoiChiaSe, string noiDungThem, bool laCongKhai)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"SQL Error in AddSharedPost: {sqlEx.Message}");
                throw new InvalidOperationException("Lỗi khi chia sẻ bài viết (SQL)", sqlEx);
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error in AddSharedPost: {ex.Message}");
        ...
        public bool DeletePost(long idPost)
        {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    using (var transaction = conn.BeginTransaction())
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            System.Diagnostics.Debug.WriteLine($"Transaction Error in DeletePost: {ex.Message}");
                            throw;
                        }
                    }
                }
            ...
            {
                System.Diagnostics.Debug.WriteLine($"SQL Error in DeletePost: {sqlEx.Message}");
                throw new InvalidOperationException("Lỗi khi xóa bài viết (SQL)", sqlEx);
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error in DeletePost: {ex.Message}");
        ...
        public bool DeleteComment(long idComment)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"SQL Error in DeleteComment: {sqlEx.Message}");
                throw new InvalidOperationException("Lỗi khi xóa bình luận (SQL)", sqlEx);
            }
            catch (Exception ex)
            {
