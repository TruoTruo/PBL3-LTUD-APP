...
namespace StudentReminderApp.ViewModels
{
    public class ShareViewModel : BaseViewModel
    {
        ...
        public string CurrentUserAvatar => string.IsNullOrEmpty(SessionManager.CurrentUser?.AvatarUrl) ? "/GUI/Resources/Images/user.png" : SessionManager.CurrentUser.AvatarUrl;
